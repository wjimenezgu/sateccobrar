...
use Yii;
use backend\models\Revmovimientos;
use backend\models\RevmovimientosSearch;
 ...
 */
class RevmovimientosController extends Controller
{
    ...
    {
        $searchModel = new RevmovimientosSearch();
    ...
    {
        if (($model = Revmovimientos::findOne($id)) !== null) {
            return $model;
        } else {
